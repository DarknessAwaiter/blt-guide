...
const commands = [
  ...
  },
  {
    name: "!аукцион",
    category: "economy",
    description: "Запустить аукцион на свой кастомный предмет по индексу с минимальной ценой. Другие зрители делают ставки, побеждает наибольшая. Узнать индекс предмета: $c(!рюкзак).",
  ...
  // === СНАРЯЖЕНИЕ ===
  {
    name: "!инв",
    category: "gear",
    description: "Показать экипировку и инвентарь героя, исключая кастомные предметы (их показывает $c(!рюкзак)).",
    syntax: "!инв"
  },
  {
    name: "!снаряга",
  ...
  },
  {
    name: "!deletitem",
    category: "gear",
    description: "Выбросить один из своих кастомных предметов по индексу. Индекс: $c(!рюкзак).",
    syntax: "!deletitem [индекс]",
    example: "!deletitem 3"
  },
  {
    name: "!датьпредмет",
    category: "gear",
    description: "Передать один из своих кастомных предметов другому зрителю. Индекс: $c(!рюкзак).",
  ...
  },
  {
    name: "!nameitem",
    category: "gear",
    description: "Дать имя кастомному предмету по индексу. Индекс: $c(!рюкзак).",
